...
namespace policy {
  namespace key {
    constexpr char kPrivacySandboxPromptEnabled[] = "";
    constexpr char kPrivacySandboxAdTopicsEnabled[] = "";
    constexpr char kPrivacySandboxSiteEnabledAdsEnabled[] = "";
    constexpr char kPrivacySandboxAdMeasurementEnabled[] = "";
  }
}
